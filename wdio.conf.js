...
exports.config = {
    ...
    */
    ...
    /*
    reporters: ['spec',['allure', {           // Spec reporter + Allure reporter
        outputDir: 'allure-results',
        disableWebdriverStepsReporting: true,
        disableWebdriverScreenshotsReporting: false,
    }]],
    */
    ...
    /*
    reporters: ['spec',                       // Spec reporter + Video reporter
        [video, {
    ...
    */
    ...
    /*
    reporters: ['spec',                        // Spec reporter + Video reporter + Allure reporter
        [video, {
          saveAllVideos: false,       // If true, also saves videos for successful test cases
          videoSlowdownMultiplier: 3, // Higher to get slower videos, lower for faster videos [Value 1-100]
        }],
    ...
    */
    ...
    /*
    reporters: ['spec',                          // Slack reporter + Spec reporter 
    [
        SlackReporter, {
    ...
    */
    ...
    /*
    reporters: ['spec', ['allure', {           // Slack reporter + Allure reporter + Spec reporter 
        outputDir: 'allure-results',
        disableWebdriverStepsReporting: true,
        disableWebdriverScreenshotsReporting: false,
    }],                      
